          ...
          {services.map((service) => {
            ...
            return (
              <motion.div
                ...
                className={`group bg-white rounded-xl border border-border overflow-hidden flex flex-col justify-between transition-all duration-300 hover:shadow-xl cursor-default ${service.glowColor}`}
              >
                {/* Top Image Banner */}
                ...
                <div className="p-6 flex flex-col justify-between flex-grow">
                  <div>
                    {/* Icon container */}
                    <div className="size-10 rounded-lg bg-muted flex items-center justify-center text-primary mb-5 group-hover:bg-primary group-hover:text-white transition-colors duration-300">
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-6">
                      {service.chips.map((chip) => (
                        <span
                          key={chip}
                          className="text-[10px] font-medium text-secondary bg-surface-container-low px-2 py-0.5 rounded-full border border-border"
                        >
                          {chip}
                        </span>
                      ))}
                    ...
                    <Link
                      ...
                      className="inline-flex items-center text-xs font-bold text-primary-container hover:text-primary transition-colors group/link mt-auto cursor-pointer"
                    >
                      Learn More
