            ...
            <ul className="flex flex-col gap-3.5">
              ...
              <li className="flex items-start gap-2.5 text-white/60 text-xs">
                ...
                <span className="flex flex-col gap-1">
                  <a href="tel:+919577291349" className="hover:text-white transition-colors">
                    <strong className="font-semibold text-white/90">India:</strong> +91-9577291349
                  </a>
                  <a href="tel:+13123139125" className="hover:text-white transition-colors">
                    <strong className="font-semibold text-white/90">USA:</strong> +1 (312) 313-9125
                  </a>
                </span>
              </li>
